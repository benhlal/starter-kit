...
const sampleEvents = [
  {
    ...
    description: "Explore the City of Light and discover hidden treasures around iconic landmarks.",
    type: "treasure-hunt",
    status: "active",
    location: {
      latitude: 48.8566,
    ...
    image: "https://images.pexels.com/photos/338515/pexels-photo-338515.jpeg?auto=compress&w=600",
    rewards: {
      coins: 1200,
      experience: 500,
  ...
  },
  {
    ...
    description: "Navigate through Central Park's scenic paths while hunting for digital treasures.",
    ...
    image: "https://images.pexels.com/photos/466685/pexels-photo-466685.jpeg?auto=compress&w=600",
    rewards: {
      coins: 950,
      experience: 400,
      badges: ["First Prize", "Second Prize", "Third Prize"],
  ...
  },
  {
    ...
    description: "Experience Tokyo's neon-lit streets in an exciting night-time treasure hunt.",
    type: "challenge",
    status: "active",
    location: {
      latitude: 35.6762,
