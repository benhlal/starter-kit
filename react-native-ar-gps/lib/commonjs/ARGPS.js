...
exports.default = exports.ARGPS = void 0;
...
const ARGPSModule = _reactNative.NativeModules.ARGPSNative ? _reactNative.NativeModules.ARGPSNative : new Proxy({}, {
  get() {
...
exports.ARGPS = ARGPS;
var _default = exports.default = ARGPS.getInstance();
