...
export const mockEvents: Event[] = [
  ...
  },
  {
    ...
    participants: [],
    organizer: { id: "event_organizer_6", name: "Medina Masters" },
    tags: ["market", "heritage", "exploration"],
    image:
      "https://images.pexels.com/photos/239520/pexels-photo-239520.jpeg?auto=compress&w=600",
    img: "https://images.pexels.com/photos/239520/pexels-photo-239520.jpeg?auto=compress&w=600",
    rewards: {
      coins: 800,
      experience: 350,
      badges: ["Souk Explorer", "Medina Guide", "Top Trader"],
    },
    visibility: "public",
    balance: "Total Prize: 800 MAD",
  ...
  },
  {
    ...
    name: "Casablanca Finance City Challenge",
    description:
    ...
    participants: [],
    organizer: { id: "event_organizer_7", name: "Casablanca Crew" },
    tags: ["city", "modern", "community"],
    image:
      "https://images.pexels.com/photos/373912/pexels-photo-373912.jpeg?auto=compress&w=600",
    img: "https://images.pexels.com/photos/373912/pexels-photo-373912.jpeg?auto=compress&w=600",
    rewards: {
      coins: 1400,
      experience: 500,
      badges: ["Skyline Sprinter", "City Navigator", "Top Finisher"],
    },
    visibility: "public",
    balance: "Total Prize: DH 1,400",
...
export const mockEventLocations: EventLocation[] = [
  ...
  },
  {
    ...
    description: "800 MAD • 240 participants",
    location: { latitude: 31.6258, longitude: -7.9891 },
    coordinate: { latitude: 31.6258, longitude: -7.9891 },
    type: "social-hub",
    radius: 100,
    interactionType: "tap",
    isActive: true,
    visitedBy: [],
    rewards: { coins: 80, experience: 35 },
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    description: "DH 1,400 • 520 participants",
    ...
    isActive: true,
    visitedBy: [],
    rewards: { coins: 140, experience: 50 },
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
];
